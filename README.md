...
PDF-version pelin ensimmäisen laitoksen käännöksestä voit ladata ilmaiseksi [Itch.io](https://kartza.itch.io/cairn-fi):sta.

Pelin koko teksti on lisensoitu [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) -käyttöluvalla. Löydät tämän sivun lähdekoodin [täältä](https://github.com/kari/cairn-fi).
