...
- Nahkainen jerkin-liivi (1 Panssari)
- Varsijousi (d8, _kookas_)
- Kaukoputki

## Mitä henkilökohtaista sääntöä tai periaatetta noudatat? Heitä 1d6:
...
| **6** | **Maksa aina velkasi**: Maksat aina takaisin sen, mitä olet velkaa, olipa se sitten rahassa tai muuten. Et odota muilta sen vähempää. Ota **Mustattu tilikirja** ja heitä sitten toisen kerran **Siteet**-taulukkoa.                                                                                                                                             |

## Mitä rotua hevosesi on? Heitä 1d6:

|       |                            |                                                                                                                                                                                                                           |
| ----- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Kylmäverinen sotaratsu** | Sodankäyntiin kasvatettu peto, hyvin vaikuttava olento. 8 HP, 1 Panssari, kaviot (d10+d10), +2 paikkaa.                                                                |
| **2** | **Mustajalkainen Keikari** | Sitkeä ja mukautuva. **Vaikea** tai **Vaarallinen** maasto on yhden askeleen helpompi. 6 HP. +4 paikkaa.                                                  |
| **3** | **Joenhammas**             | Vaikuttavan vahva, pystyy kantamaan raskaita kuormia. 4 HP. +6 paikkaa (vain +2 paikkaa, jos kantaa kahta henkilöä).                                   |
| **4** | **Kirjava Cob**            | Älykäs, se ymmärtää yksinkertaisia käskyjä ja sillä on jopa vaaranvaisto. 6 HP. +4 paikkaa.                                                                               |
| **5** | **Valkoinen lehmus**       | Erittäin hyvin koulutettu ja ketterä, se pystyy suorittamaan monimutkaisia liikkeitä tarvittaessa (ei DEX-pelastusheittoa paetessa). 4 HP. +3 paikkaa. |
| **6** | **Metsänkulkuri**          | Villi mutta erittäin nopea (jopa **Vaikeassa** maastossa). Ratsastaa kevyesti. 4 HP. +2 paikkaa.                                       |
