...
## Mistä lauluista sinut tunnetaan parhaiten? Heitä 1d6:
...
## Millä maksat matkasi maan halki? Heitä 1d6:

|       |                          |                                                                                                                                                                                                                                 |
| ----- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Esiintyminen**         | Esiintyminen kapakoissa kattaa aina niin huoneen että ylläpidon. Joskus saat jopa juomarahaa! Aloita **10gp**:llä ylimääräistä.                                                                                                 |
| **2** | **Henkivartija**         | Olet suojelija niille, jotka pelkäävät matkustaa yksin. Aloita **Säilällä** (d8).                                                                                                                                               |
| **3** | **Kauppatavarat**        | Ostat halvalla ja myyt kalliilla, tienaat aina juuri sen verran, että tulet toimeen. Ota [varustetaulukosta](/second-edition/players-guide/marketplace#varusteet) **yksittäinen esine**, jonka arvo on **20gp** (tai vähemmän). |
| **4** | **Kuljetus**             | Toimitat "hienovaraisia" paketteja ympäri maita. Sinulla on vähintään yksi yhteyshenkilö missä tahansa isommassa kylässä.                                                                                                       |
| **5** | **Merenkulkijan kaveri** | Yli levottomien vesien ja vaarallisten tuulten pidät huolta aina siitä, että laiva pääsee perille. Sinulle matka on aina ilmainen.                                                                                              |
| **6** | **Opas**                 | Paimennat karavaaneja ja matkustajia vetisillä mailla. Aloita seuraavaan matkaasi liittyvällä **kartalla** (_mitätön_).                                                                                                         |
