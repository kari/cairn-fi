...
## Missä ansaitsit jousesi? Heitä 1d6:
...
## Millaisesta puusta jousesi on tehty? Heitä 1d6:
...
| **5** | **Raitainen bambu** (d6). Kokoontaitettava, vie vain yhden paikan (mutta vaatii silti molemmat kädet).               |
| **6** | **Vuorijalavasta** (d6, _kookas_). Suojaa kantajaansa myrkyiltä niin kauan kuin hän pitää sitä käsissään.                               |