---
layout: default
title: Tietämys ja tarkkaavaisuus
...
- **Miekka**: Kengänjäljet maassa johtavat sitä kohti, mutta loppuvat äkillisesti muutaman metrin päähän.
  ...
  - Veriköynnös [3 HP, 4 STR, 13 DEX, 1 WIL, kärhet (d6, _räjähdys_)] hyökkää jokaisen miekkaa lähestyvän kimppuun ja imee kohteelta 1 STR per kierros (STR-pelastusheitto pakenemiseen ensimmäisen kierroksen jälkeen).
