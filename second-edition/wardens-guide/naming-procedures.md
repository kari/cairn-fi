...
- Asutukset nimetään usein niiden erityispiirteiden mukaan (joen mutka, suuri tuulimylly kaupungin keskustassa). Asukkaat lisäävät nimeen substantiivin tai adjektiivin: _Tuulinen kuru_, _Mustapuun linnoitus_, jne.
- Tärkeät paikat kantavat merkittäviä nimiä: sankareita, pyhimyksiä, valtiaita tai historiallisia tapahtumia. _Saint Ibizin kappeli, Kuningattaren Elonkorjuu, Yhdeksännen valo_ jne.
- Erisnimiä voidaan lisätä nimeen: _Brunan ruma kuru_.
- Villi ja vaarallinen luonto nimetään selkeiden vaarojen mukaan: _Myrkkyjärvi_, _Sumuiset jyrkänteet_, jne.
- Jotkut nimet kertovat tarinan: _Lukan Oikku_, _Kuolleen miehen polku_, jne.
- Käytä tarvittaessa alueen paikallista maastoa ja sijainnin yksityiskohtia.

## Nimien luominen

- Heitä noppaa [Nimikaavat](#nimikaavat) -taulukolla kunkin Kohdepisteen osalta.
- Heitä tarvittaessa [Adjektiivit](#adjektiivit) ja [Substantiivit](#substantiivit) -taulukoilla.
- Heittääksesi **1d100**, heität **2d10**, käyttäen yhtä noppaa kymmeninä ja toista ykkösinä.

> Jos haluat nimetä alueita maaston perusteella, vaihda "Kohdepiste" maastotyyppiin ja katso [Maaston synonyymit](#maaston-synonyymit) -taulukkoa inspiraatiota varten.
