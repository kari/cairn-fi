...
- Heitä [Hirviön ulkonäkö](#hirviön-ulkonäkö) -taulukkoa.
- Heitä [Hirviön piirteet](#hirviön-piirteet) -taulukkoa.
- Heitä [Hirviön hyökkäykset](#hirviön-hyökkäykset) -taulukkoa.
- Heitä [Hirviön kyvyt](#hirviön-kyvyt) -taulukkoa.
- Kuvaile olennon ulkonäkö, kyvyt ja hyökkäykset selkeällä kielellä.
- Luo olennon tilastot alla olevien periaatteiden, määritelmien ja tietolaatikkomallin mukaisesti.
...
X HP, X Panssari, X STR, X DEX, X WIL, Hyökkäys (dX, erityiset esineet, _ominaisuudet_)
...
- **Ulkonäkö**: _Kyyryisä_ + _Selkäkilpi_.
- **Piirteet**: _Liikkuu suorassa linjassa_ + _Heikko kohta_
- **Hyökkäys**: _Iskee_ + _Tarttuu_.
- **Kyvyt**: _Estää_ + _Kuulo_

_Etanamainen olento, jolla on kova kuori. Se liikkuu vain suorassa linjassa ja sillä on pehmeä vatsa. Se vierii vastustajiensa päälle ja vetää heidät hurjalle kiertoradalleen. Sen liikkeen pauhu hukuttaa alleen kaikki muut äänet._
...
- Voit käyttää _pelastusheittoja_ saadaksesi lisäinformaatiota olennon kyvyistä, erityisesti sen kyvystä välttää fyysisen vamman, taikuuden tai myrkyn aiheuttama kuolema.
...
Voi ottaa ketun tai kaksimetrisen ketunpäisen naisen muodon.
_HD 5, Nopeus 120', Panssari 14, Taistelutahto 11, Hyökkäys: +4 d8hp (kynnet, puraisu tai kuristus)_
