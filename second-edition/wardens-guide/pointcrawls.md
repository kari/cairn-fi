...
Seuraava menetelmä nojautuu pitkälti Cairnin toisen laitoksen (2e) Pelaajan oppaasta löytyviin Erämaan tutkimisen menettelyihin.
...
Matka-ajat pisteiden välillä määriteltiin seuraavasti (olettaen että seurue matkaa jalan):

- Pisteiden **1** ja **2** välinen matka on 6 Vahtivuoroa:
  - Lisää kaksi Vahtivuoroa reitin _keskipitkän_ etäisyyden vuoksi.
  - Lisää yksi Vahtivuoro vuorten ja metsien halki kulkevan _polun_ vuoksi.
  - Lisää kaksi Vahtivuoroa _vaarallisen_ vuoristomaaston ja 1 Vahtivuoro metsän vuoksi.
- Pisteiden **2** ja **3** välinen matka on 4 Vahtivuoroa:
  - Lisää yksi Vahtivuoro reitin _lyhyen_ etäisyyden vuoksi.
  - Lisää yksi Vahtivuoro vuorten halki kulkevan _polun_ vuoksi.
  - Lisää kaksi Vahtivuoroa _vaarallisen_ vuoristomaaston takia.
- Pisteiden **2** ja **4** välinen matka on kolme Vahtivuoroa:
  - Lisää kaksi Vahtivuoroa reitin _keskipitkän_ etäisyyden vuoksi.
  - Älä lisää mitään sakkoa ylläpidetyn _tien_ vuoksi.
  - Lisää yksi Vahtivuoro _vaikean_ metsämaaston vuoksi.
- Pisteiden **4** ja **5** välinen matka on neljä Vahtivuoroa:
  - Lisää yksi Vahtivuoro reitin _lyhyen_ etäisyyden vuoksi.
  - Lisää yksi Vahtivuoro suon ylittävän _polun_ vuoksi.
  - Lisää kaksi Vahtivuoroa _vaarallisen_ suomaaston takia.
- Pisteiden **4** ja **6** välinen matka on 4 Vahtivuoroa:
  - Lisää kaksi Vahtivuoroa reitin _keskipitkän_ etäisyyden vuoksi.
  - Lisää yksi Vahtivuoro tasangon ylittävän _polun_ vuoksi.
  - Älä lisää mitään sakkoa _helpon_ tasankomaaston vuoksi.
- Matkan pisteeseen **7** mistä tahansa muusta pisteestä pitäisi olla vähintään 5 Vahtivuoroa:
  - Lisää kaksi Vahtivuoroa reitin _keskipitkän_ etäisyyden vuoksi.
