...
| ------- | --------------------------------------------------------- | ------ | ---------------------------------------------------------- |
| **d20** | **Tausta**                                                |        |                                                            |
| **1**   | [Salaseppä](/second-edition/backgrounds/aurifex)          | **11** | [Noidanpuolikas](/second-edition/backgrounds/half-witch)   |
| **2**   | [Välskäri](/second-edition/backgrounds/barber-surgeon)    | **12** | [Noidansurma](/second-edition/backgrounds/hexenbane)       |
| **3**   | [Pedonhoitaja](/second-edition/backgrounds/beast-handler) | **13** | [Jonglööri](/second-edition/backgrounds/jongleur/)         |
| **4**   | [Luunvartija](/second-edition/backgrounds/bonekeeper/)    | **14** | [Kattilamaakari](/second-edition/backgrounds/kettlewright) |
| **5**   | [Taskuvaras](/second-edition/backgrounds/cutpurse)        | **15** | [Rajavartija](/second-edition/backgrounds/marchguard/)     |
| **6**   | [Pellonvartija](/second-edition/backgrounds/fieldwarden/) | **16** | [Puoskari](/second-edition/backgrounds/mountebank)         |
| **7**   | [Sulkatuuli](/second-edition/backgrounds/fletchwind)      | **17** | [Eräratsastaja](/second-edition/backgrounds/outrider)      |
| **8**   | [Löytölapsi](/second-edition/backgrounds/foundling)       | **18** | [Vaanija](/second-edition/backgrounds/prowler)             |
| **9**   | [Sienestäjä](/second-edition/backgrounds/fungal-forager)  | **19** | [Puronkulkija](/second-edition/backgrounds/rill-runner)    |
| **10**  | [Vihertaituri](/second-edition/backgrounds/greenwise/)    | **20** | [Kirjuri](/second-edition/backgrounds/scrivener)           |
...
| ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **D20** | **Side**                                                                                                                                                                                                                                                                                                         |
| **1**   | Perit kauan sitten kuolleelta sukulaiselta **yhden jalokiven** (500gp, kylmä ja hauras). Se saapui varoituksen kera: tuhlaa uudet rikkautesi ja pitkään unohdetuksi luultu velka tulee maksettavaksi.                                         |
| **2**   | Kaukainen serkku jätti sinulle pienen perinnön. Ota **20gp** ja **omituinen kompassi** (_mitätön_), joka osoittaa aina kohti jotain syvällä Korven siimeksessä.                                                                                               |
| **3**   | Kannat medaljongissa (_mitätön_) **muotokuvaa** entisestä rakkaudesta, joka katosi Korpeen kauan sitten. Jotenkin tiedät, että hän on yhä elossa.                                                                                                             |
| **4**   | Löysit multaan hautautuneen **pienen kristalliprisman** (_mitätön_). Kun sitä pidetään valoa vasten, se näyttää näkyjä tuntemattomasta paikasta syvällä Korven siimeksessä. Joskus tunnet jonkin olemuksen katsovan sinua kohti.              |
...
| **13**  | Kohtasit metsässä haavoittuneen pedon, mutta päätit jättää sen oman onnensa nojaan. Näet sen nyt kaikkialla, mutta vain silloin kun olet yksin. Se näyttää surulliselta muttei vihaiselta. Yksin toimiessasi et voi joutua _paniikkiin_.         |
| **14**  | Lupasit lapsuudenystävällesi tuoda hänelle harvinaisen lahjan, jotain ainutlaatuista koko maailmassa. Ota **rannekoru** (_mitätön_), joka on kudottu langasta ja villikukista.                                                                                |
| **15**  | Kohtasit Korvessa olennon, joka kirosi sinut **Kivisydämellä**. Joka kuukausi kivi kasvaa yhden paikan verran raskaammaksi. Ennen kuin velkasi on maksettu, et voi todella kuolla.                                                                               |
...
| **8**   | On kylä, joka tunnetaan laajalti vaikuttavasta "äitipuusta", jonka sanotaan kätkevän kylän salaisuudet oksiinsa. Viime aikoina se on alkanut vuotaa punaista mahlaa, mikä huolestuttaa kylänvanhimpia.                                                                             |
| **9**   | Kuu muuttuu syvän purppuranpunaiseksi ja kylvää yön aavemaiseen, verenpunaiseen valoon. Sen sanotaan enteilevän kaaoksen ja eripuran aikaa, kun rajat Korven ja kuolevaisten valtakunnan välillä hämärtyvät.                                                                       |
| **10**  | Yötaivaalle on ilmestynyt outoja halkeamia, joista paljastuu valon ja värien pyörteitä. Jotkut sanovat, että maailmojen välinen kuilu on heikoimmillaan vuosisatoihin, ja pelkäävät mitä sen toiselta puolelta voi ilmestyä.                                                       |
...
| **18**  | Patsaat ovat itkeneet verta jo kuukausia, ja kyläläisten kohdut ovat sen jälkeen olleet hedelmättömiä.  Ainoa poikkeus on ollut lapsi, jonka kylänvanhimmat ovat piilottaneet pelon ja kauhun vallassa.                                                                            |
| **19**  | Paikallinen eläimistö on alkanut käyttäytymään oudosti, osoittaen lisääntynyttä aggressiivisuutta tai paeten alueelta kokonaan. Metsästäjät puhuvat hämärästä hahmosta, joka vaeltaa Korvessa kutsuen eläimiä.                                                                     |
| **20**  | Rajakaupungeissa on viime viikkoina mellakoitu sen jälkeen, kun useat ovat kertoneet, että heidän lastensa uniin on ilmestynyt punakaapuinen hahmo, joka lausuu saman varoituksen: Tuli on tulossa, ja se nielee kaiken.                                                           |